...
const VOICES = Object.freeze({
  ...
  softGuitar: { waveform: 'triangle', attackSeconds: 0.006, releaseSeconds: 0.46, filterFrequency: 1750, gainScale: 0.82 },
  clarinet: { waveform: 'square', attackSeconds: 0.055, releaseSeconds: 0.32, filterFrequency: 1180, gainScale: 0.34 },
  marimba: { waveform: 'sine', attackSeconds: 0.003, releaseSeconds: 0.27, filterFrequency: 2600, gainScale: 0.78 },
  roundBass: { waveform: 'sine', attackSeconds: 0.018, releaseSeconds: 0.35, filterFrequency: 700 },
  folkBrush: { filterType: 'bandpass', filterFrequency: 1850, q: 0.72, attackSeconds: 0.002, releaseSeconds: 0.07, gainScale: 0.68 },
  woodTap: { filterType: 'bandpass', filterFrequency: 980, q: 1.3, attackSeconds: 0.002, releaseSeconds: 0.05, gainScale: 0.72 },
  ...
  pizzicato: { waveform: 'triangle', attackSeconds: 0.004, releaseSeconds: 0.22, filterFrequency: 1420, gainScale: 0.78 },
  mutedWoodwind: { waveform: 'square', attackSeconds: 0.035, releaseSeconds: 0.2, filterFrequency: 920, gainScale: 0.28 },
  ...
  softBell: { waveform: 'sine', attackSeconds: 0.025, releaseSeconds: 1.05, filterFrequency: 2800, gainScale: 0.82 },
